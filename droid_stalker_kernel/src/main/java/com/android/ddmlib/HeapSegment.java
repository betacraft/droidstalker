...
public final class HeapSegment implements Comparable<HeapSegment> {
    ...
    public static class HeapSegmentElement implements Comparable<HeapSegmentElement> {
         ...
         * @throws java.nio.BufferUnderflowException if there is not a whole entry
         *                                  following the current position
         *                                  of hpsgData.
         * @throws java.text.ParseException           if the provided data is malformed.
         */
     ...
     * @throws java.nio.BufferUnderflowException if hpsgData is too small
