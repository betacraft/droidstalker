...
public final class Log {
    ...
    public enum LogLevel {
        ...
        /**
         * Returns the {@link com.android.ddmlib.Log.LogLevel} enum matching the specified letter.
        ...
        /**
         * Returns the letter identifying the priority of the {@link com.android.ddmlib.Log.LogLevel}.
         */
    ...
    public interface ILogOutput {
         ...
         * @param logLevel The {@link com.android.ddmlib.Log.LogLevel} enum representing the priority of the message.
    ...
    /**
     * Outputs a {@link com.android.ddmlib.Log.LogLevel#VERBOSE} level message.
     * @param tag The tag associated with the message.
    ...
    /**
     * Outputs a {@link com.android.ddmlib.Log.LogLevel#DEBUG} level message.
     * @param tag The tag associated with the message.
     * @param message The message to output.
     */
    ...
    /**
     * Outputs a {@link com.android.ddmlib.Log.LogLevel#INFO} level message.
     * @param tag The tag associated with the message.
     * @param message The message to output.
     */
    ...
    /**
     * Outputs a {@link com.android.ddmlib.Log.LogLevel#WARN} level message.
     * @param tag The tag associated with the message.
     * @param message The message to output.
     */
    ...
    /**
     * Outputs a {@link com.android.ddmlib.Log.LogLevel#ERROR} level message.
     * @param tag The tag associated with the message.
     * @param message The message to output.
     */
    ...
    /**
     * Outputs a {@link com.android.ddmlib.Log.LogLevel#ERROR} level {@link Throwable} information.
     * @param tag The tag associated with the message.
    ...
    /**
     * Sets the {@link com.android.ddmlib.Log.ILogOutput} to use to print the logs. If not set, {@link System#out}
     * will be used.
     * @param logOutput The {@link com.android.ddmlib.Log.ILogOutput} to use to print the log.
     */
