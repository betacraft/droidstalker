...
/**
 * Exception thrown when a transfer using {@link com.android.ddmlib.SyncService} doesn't complete.
 * <p/>This is different from an {@link java.io.IOException} because it's not the underlying connection
