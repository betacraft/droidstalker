...
public final class LogReceiver {
    ...
    public static final class LogEntry {
        ...
        /** pid of the process that generated this {@link com.android.ddmlib.log.LogReceiver.LogEntry} */
        public int   pid;
        /** tid of the process that generated this {@link com.android.ddmlib.log.LogReceiver.LogEntry} */
        public int   tid;
        /** Seconds since epoch. */
        public int   sec;
        /** nanoseconds. */
     ...
     * with {@link com.android.ddmlib.log.LogReceiver.LogEntry} objects coming from log service through a {@link com.android.ddmlib.log.LogReceiver}.
     * <p/>This interface provides two methods.
     * <ul>
     * <li>{@link #newEntry(com.android.ddmlib.log.LogReceiver.LogEntry)} provides a
     * first level of parsing, extracting {@link com.android.ddmlib.log.LogReceiver.LogEntry} objects out of the log service output.</li>
    ...
    public interface ILogListener {
        /**
         * Sent when a new {@link com.android.ddmlib.log.LogReceiver.LogEntry} has been parsed by the {@link com.android.ddmlib.log.LogReceiver}.
    ...
    /** Current {@link com.android.ddmlib.log.LogReceiver.LogEntry} being read, before sending it to the listener. */
    ...
    /** Listener waiting for receive fully read {@link com.android.ddmlib.log.LogReceiver.LogEntry} objects */
    private ILogListener mListener;

    private boolean mIsCancelled = false;
    
    /**
     * Creates a {@link com.android.ddmlib.log.LogReceiver} with an {@link com.android.ddmlib.log.LogReceiver.ILogListener}.
     * <p/>
     * The {@link com.android.ddmlib.log.LogReceiver.ILogListener} will receive new log entries as they are parsed, in the form
     * of {@link com.android.ddmlib.log.LogReceiver.LogEntry} objects.
    ...
    /**
     * Creates a {@link com.android.ddmlib.log.LogReceiver.LogEntry} from the array of bytes. This expects the data buffer size
     ...
     * @return a new {@link com.android.ddmlib.log.LogReceiver.LogEntry} or <code>null</code> if some error happened.
     */
