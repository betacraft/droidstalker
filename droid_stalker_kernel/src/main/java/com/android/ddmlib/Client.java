...
public class Client {
    ...
    /**
     * Client change bit mask: combination of {@link com.android.ddmlib.Client#CHANGE_NAME},
     * {@link com.android.ddmlib.Client#CHANGE_DEBUGGER_STATUS}, and {@link com.android.ddmlib.Client#CHANGE_PORT}.
     */
     ...
     * @param chan   the connected {@link java.nio.channels.SocketChannel}.
    ...
    /**
     * Returns a string representation of the {@link com.android.ddmlib.Client} object.
     */
    @Override
     ...
     * {@link IClientChangeListener#clientChanged(com.android.ddmlib.Client, int)} with a <code>changeMask</code>
     ...
     * will be received through {@link IClientChangeListener#clientChanged(com.android.ddmlib.Client, int)}
    ...
    public void requestAllocationStatus() {
        try {
            ...
            logger.error("Error while sending REAQ", e);
        }
    }
     ...
     *
     * @see AndroidDebugBridge#setSelectedClient(com.android.ddmlib.Client)
    ...
    boolean sendHandshake() {
        ...
        try {
            ...
            logger.error("IO error during handshake", ioe);
            mConnState = ST_ERROR;
            close(true /* notify */);
            return false;
        } finally {
    ...
    /**
     * Returns whether this {@link com.android.ddmlib.Client} has a valid connection to the application VM.
     */
