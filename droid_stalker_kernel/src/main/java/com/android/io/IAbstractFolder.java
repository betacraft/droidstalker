...
public interface IAbstractFolder extends IAbstractResource {
    ...
    /**
     * Returns an {@link com.android.io.IAbstractFile} representing a child of the current folder with the
    ...
    /**
     * Returns an {@link com.android.io.IAbstractFolder} representing a child of the current folder with the
     ...
     * @return An array of file names (generated using {@link java.io.File#getName()}).
