...
public class ThreadInfoStruct implements org.apache.thrift.TBase<ThreadInfoStruct, ThreadInfoStruct._Fields>, java.io.Serializable, Cloneable, Comparable<ThreadInfoStruct> {
  ...
  public void validate() throws TException {
    ...
    if (!isSetThreadId()) {
      throw new TProtocolException("Required field 'threadId' is unset! Struct:" + toString());
    }
    ...
    if (!isSetTimeId()) {
      throw new TProtocolException("Required field 'timeId' is unset! Struct:" + toString());
    }
    ...
    if (!isSetStartTime()) {
      throw new TProtocolException("Required field 'startTime' is unset! Struct:" + toString());
    }

    if (!isSetIsDaemon()) {
      throw new TProtocolException("Required field 'isDaemon' is unset! Struct:" + toString());
    }

    if (!isSetTraceTime()) {
      throw new TProtocolException("Required field 'traceTime' is unset! Struct:" + toString());
    }
  ...
  private static class ThreadInfoStructStandardScheme extends StandardScheme<ThreadInfoStruct> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ThreadInfoStruct struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThreadInfoStruct struct) throws TException {
      struct.validate();
  ...
  private static class ThreadInfoStructTupleScheme extends TupleScheme<ThreadInfoStruct> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ThreadInfoStruct struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ThreadInfoStruct struct) throws TException {
