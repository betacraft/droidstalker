...
/**
 * Contains the data of a {@link com.android.ddmlib.Client}.
 */
public class ClientData {
    ...
    */
    ...
    public static enum AllocationTrackingStatus {
         ...
         * <p/>This happens right after a {@link com.android.ddmlib.Client} is discovered
         * by the {@link AndroidDebugBridge}, and before the {@link com.android.ddmlib.Client} answered the query
         * regarding its allocation tracking status.
         * @see com.android.ddmlib.Client#requestAllocationStatus()
         */
        UNKNOWN,
        /** Allocation tracking status: the {@link com.android.ddmlib.Client} is not tracking allocations. */
        OFF,
        /** Allocation tracking status: the {@link com.android.ddmlib.Client} is tracking allocations. */
        ON
    }
    ...
    public static enum MethodProfilingStatus {
         ...
         * @see com.android.ddmlib.Client#requestMethodProfilingStatus()
         */
        UNKNOWN,
        /** Method profiling status: the {@link com.android.ddmlib.Client} is not profiling method calls. */
        OFF,
        /** Method profiling status: the {@link com.android.ddmlib.Client} is profiling method calls. */
        ON
    }

    /**
     * Name of the value representing the max size of the heap, in the {@link java.util.Map} returned by
     * {@link #getVmHeapInfo(int)}
     */
    public static final String HEAP_MAX_SIZE_BYTES = "maxSizeInBytes"; //$NON-NLS-1$
    /**
     * Name of the value representing the size of the heap, in the {@link java.util.Map} returned by
     * {@link #getVmHeapInfo(int)}
     */
     ...
     * {@link java.util.Map} returned by {@link #getVmHeapInfo(int)}
     */
    public static final String HEAP_BYTES_ALLOCATED = "bytesAllocated"; //$NON-NLS-1$
    /**
     * Name of the value representing the number of objects in the heap, in the {@link java.util.Map}
    ...
    /**
     * Returns the {@link com.android.ddmlib.ClientData.HeapData} object for the VM.
     */
    ...
    /**
     * Returns the {@link com.android.ddmlib.ClientData.HeapData} object for the native code.
     */
     ...
     * <p/>
     * The caller must synchronize on the {@link com.android.ddmlib.ClientData} object while iterating.
     *
     ...
     * {@link com.android.ddmlib.Client#requestThreadUpdate()}.
     */
     ...
     * @see com.android.ddmlib.Client#requestNativeHeapInformation()
     */
    ...
    /**
     * adds a new {@link NativeAllocationInfo} to the {@link com.android.ddmlib.Client}
     ...
     * @see com.android.ddmlib.Client#requestAllocationDetails()
     */
    ...
    /**
     * Returns true if the {@link com.android.ddmlib.Client} supports the given <var>feature</var>
     * @param feature The feature to test.
     * @return true if the feature is supported
     *
     * @see com.android.ddmlib.ClientData#FEATURE_PROFILING
     * @see com.android.ddmlib.ClientData#FEATURE_HPROF
     */
