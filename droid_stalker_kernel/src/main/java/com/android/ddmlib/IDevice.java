...
public interface IDevice extends IShellEnabledDevice {
    ...
    /** Device change bit mask: {@link com.android.ddmlib.IDevice.DeviceState} change. */
    public static final int CHANGE_STATE = 0x0001;
    /** Device change bit mask: {@link com.android.ddmlib.Client} list change. */
    ...
    public static enum DeviceState {
        ...
        /**
         * Returns a {@link com.android.ddmlib.IDevice.DeviceState} from the string returned by <code>adb devices</code>.
         *
         * @param state the device state.
         * @return a {@link com.android.ddmlib.IDevice.DeviceState} object or <code>null</code> if the state is unknown.
         */
     ...
     *
     * @return <code>true</code> if {@link #getState()} returns {@link com.android.ddmlib.IDevice.DeviceState#ONLINE}.
     */
     ...
     *
     * @return <code>true</code> if {@link #getState()} returns {@link com.android.ddmlib.IDevice.DeviceState#OFFLINE}.
     */
     ...
     *
     * @return <code>true</code> if {@link #getState()} returns {@link com.android.ddmlib.IDevice.DeviceState#BOOTLOADER}.
     */
    public boolean isBootLoader();

    /**
     * Returns whether the {@link com.android.ddmlib.Device} has {@link com.android.ddmlib.Client}s.
     */
    ...
    /**
     * Returns a {@link com.android.ddmlib.Client} by its application name.
     *
     ...
     *            refuse to open the connection because the {@link com.android.ddmlib.IDevice} is invalid
     *            (or got disconnected).
     * @throws TimeoutException in case of timeout on the connection.
     * @throws AdbCommandRejectedException if adb rejects the command
     * @throws java.io.IOException if the connection with adb failed.
     */
    ...
    /**
     * Runs the event log service and outputs the event log to the {@link com.android.ddmlib.log.LogReceiver}.
     * <p/>This call is blocking until {@link com.android.ddmlib.log.LogReceiver#isCancelled()} returns true.
    ...
    /**
     * Runs the log service for the given log and outputs the log to the {@link com.android.ddmlib.log.LogReceiver}.
     * <p/>This call is blocking until {@link com.android.ddmlib.log.LogReceiver#isCancelled()} returns true.
     *
