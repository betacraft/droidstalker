...
public final class LogCatFilter {
    ...
    /**
     * Obtain the flags to pass to {@link java.util.regex.Pattern#compile(String, int)}. This method
    ...
    /**
     * Construct a list of {@link com.android.ddmlib.logcat.LogCatFilter} objects by decoding the query.
