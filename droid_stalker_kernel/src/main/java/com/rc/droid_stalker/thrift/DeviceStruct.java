...
public class DeviceStruct implements org.apache.thrift.TBase<DeviceStruct, DeviceStruct._Fields>, java.io.Serializable, Cloneable, Comparable<DeviceStruct> {
  ...
  public void validate() throws TException {
    ...
    if (!isSetAvdName()) {
      throw new TProtocolException("Required field 'avdName' is unset! Struct:" + toString());
    }
    ...
    if (!isSetBatteryPercentage()) {
      throw new TProtocolException("Required field 'batteryPercentage' is unset! Struct:" + toString());
    }
