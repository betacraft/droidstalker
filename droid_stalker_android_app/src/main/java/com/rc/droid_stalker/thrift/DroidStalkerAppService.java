...
public class DroidStalkerAppService {
  ...
  public interface Iface {
     ...
     */
    public Set<AndroidAppStruct> getInstalledApps() throws DroidStalkerAppException, TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getInstalledApps() throws TException
    {
      getInstalledApps_args args = new getInstalledApps_args();
      sendBase("getInstalledApps", args);
    }

    public Set<AndroidAppStruct> recv_getInstalledApps() throws DroidStalkerAppException, TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getInstalledApps_call extends org.apache.thrift.async.TAsyncMethodCall {
      public getInstalledApps_call(AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
      ...
      public Set<AndroidAppStruct> getResult() throws DroidStalkerAppException, TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getInstalledApps<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getInstalledApps_args> {
      ...
      public getInstalledApps_result getResult(I iface, getInstalledApps_args args) throws TException {
        getInstalledApps_result result = new getInstalledApps_result();
        try {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getInstalledApps<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getInstalledApps_args, Set<AndroidAppStruct>> {
      public getInstalledApps() {
        super("getInstalledApps");
      }
      ...
      public void start(I iface, getInstalledApps_args args, AsyncMethodCallback<Set<AndroidAppStruct>> resultHandler) throws TException {
...
;
    ...
    private static class getInstalledApps_argsStandardScheme extends StandardScheme<getInstalledApps_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getInstalledApps_args struct) throws TException {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getInstalledApps_args struct) throws TException {
        struct.validate();
    ...
    private static class getInstalledApps_argsTupleScheme extends TupleScheme<getInstalledApps_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getInstalledApps_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
      }

      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getInstalledApps_args struct) throws TException {
  ...
  public static class getInstalledApps_result implements org.apache.thrift.TBase<getInstalledApps_result, getInstalledApps_result._Fields>, java.io.Serializable, Cloneable, Comparable<getInstalledApps_result>   {
    ...
    private static class getInstalledApps_resultStandardScheme extends StandardScheme<getInstalledApps_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getInstalledApps_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.success = new HashSet<AndroidAppStruct>(2*_set0.size);
                  for (int _i1 = 0; _i1 < _set0.size; ++_i1)
                  {
                    AndroidAppStruct _elem2;
                    _elem2 = new AndroidAppStruct();
                    _elem2.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getInstalledApps_result struct) throws TException {
        struct.validate();
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (AndroidAppStruct _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeSetEnd();
    ...
    private static class getInstalledApps_resultTupleScheme extends TupleScheme<getInstalledApps_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getInstalledApps_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (AndroidAppStruct _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getInstalledApps_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new HashSet<AndroidAppStruct>(2*_set5.size);
            for (int _i6 = 0; _i6 < _set5.size; ++_i6)
            {
              AndroidAppStruct _elem7;
              _elem7 = new AndroidAppStruct();
              _elem7.read(iprot);
