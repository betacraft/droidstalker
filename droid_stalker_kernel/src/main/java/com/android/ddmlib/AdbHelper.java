 ...
 * <p/>{@link DebugBridgeServer} is the public API to connection to adb, while {@link com.android.ddmlib.AdbHelper}
...
public final class AdbHelper {
    ...
    /**
     * @deprecated Use {@link #executeRemoteCommand(java.net.InetSocketAddress, String, com.android.ddmlib.IDevice, IShellOutputReceiver, long, java.util.concurrent.TimeUnit)}.
     */
    @Deprecated
     ...
     *
     * @param adbSockAddr             the {@link java.net.InetSocketAddress} to adb.
     * @param command                 the shell command to execute
     * @param device                  the {@link com.android.ddmlib.IDevice} on which to execute the command.
    ...
    /**
     * Runs the Event log service on the {@link com.android.ddmlib.Device}, and provides its output to the
     * {@link com.android.ddmlib.log.LogReceiver}.
     ...
     * @param rcvr        the {@link com.android.ddmlib.log.LogReceiver} to receive the log output
     * @throws TimeoutException            in case of timeout on the connection.
     * @throws AdbCommandRejectedException if adb rejects the command
     * @throws java.io.IOException         in case of I/O error on the connection.
     */
    ...
    /**
     * Runs a log service on the {@link com.android.ddmlib.Device}, and provides its output to the {@link com.android.ddmlib.log.LogReceiver}.
     * <p/>This call is blocking until {@link com.android.ddmlib.log.LogReceiver#isCancelled()} returns true.
     *
     * @param adbSockAddr the socket address to connect to adb
     * @param device      the Device on which to run the service
