...
public final class AndroidDebugBridge {
     ...
     * with {@link com.android.ddmlib.AndroidDebugBridge} changes.
     */
    public interface IDebugBridgeChangeListener {
        /**
         * Sent when a new {@link com.android.ddmlib.AndroidDebugBridge} is connected.
         * <p/>
         * This is sent from a non UI thread.
         *
         * @param bridge the new {@link com.android.ddmlib.AndroidDebugBridge} object.
         */
     ...
     * with {@link com.android.ddmlib.IDevice} addition, deletion, and changes.
     */
    public interface IDeviceChangeListener {
        /**
         * Sent when the a device is connected to the {@link com.android.ddmlib.AndroidDebugBridge}.
         * <p/>
         * This is sent from a non UI thread.
         *
         ...
         *                   values: {@link com.android.ddmlib.IDevice#CHANGE_BUILD_INFO}, {@link com.android.ddmlib.IDevice#CHANGE_STATE},
         *                   {@link com.android.ddmlib.IDevice#CHANGE_CLIENT_LIST}
         */
    ...
    /**
     * Classes which implement this interface provide methods that deal
     * with {@link com.android.ddmlib.Client}  changes.
     */
    public interface IClientChangeListener {
         ...
         *                   any of the following values: {@link com.android.ddmlib.Client#CHANGE_INFO},
         *                   {@link com.android.ddmlib.Client#CHANGE_DEBUGGER_STATUS}, {@link com.android.ddmlib.Client#CHANGE_THREAD_MODE},
         *                   {@link com.android.ddmlib.Client#CHANGE_THREAD_DATA}, {@link com.android.ddmlib.Client#CHANGE_HEAP_MODE},
         *                   {@link com.android.ddmlib.Client#CHANGE_HEAP_DATA}, {@link com.android.ddmlib.Client#CHANGE_NATIVE_HEAP_DATA}
         */
     ...
     * the applications to debug. See {@link com.android.ddmlib.Client#getDebuggerListenPort()}.
     ...
     * @param clientSupport Indicates whether the library should enable the monitoring and
     *                      interaction with applications running on the devices.
     * @see com.android.ddmlib.AndroidDebugBridge#createBridge(String, boolean)
     * @see com.android.ddmlib.DdmPreferences
     */
     ...
     * {@link com.android.ddmlib.Client}s running on the {@link com.android.ddmlib.IDevice}s.
     */
    ...
    /**
     * Creates a {@link com.android.ddmlib.AndroidDebugBridge} that is not linked to any particular executable.
     ...
     * {@link com.android.ddmlib.AndroidDebugBridge} is connected, by sending it one of the messages defined
     * in the {@link com.android.ddmlib.AndroidDebugBridge.IDebugBridgeChangeListener} interface.
     *
     ...
     * {@link com.android.ddmlib.AndroidDebugBridge} is started.
     *
    ...
    /**
     * Adds the listener to the collection of listeners who will be notified when a {@link com.android.ddmlib.IDevice}
     * is connected, disconnected, or when its properties or its {@link com.android.ddmlib.Client} list changed,
     * by sending it one of the messages defined in the {@link com.android.ddmlib.AndroidDebugBridge.IDeviceChangeListener} interface.
     *
     * @param listener The listener which should be notified.
     */
     ...
     * {@link com.android.ddmlib.IDevice} is connected, disconnected, or when its properties or its {@link com.android.ddmlib.Client}
     * list changed.
     *
     * @param listener The listener which should no longer be notified.
     */
    ...
    /**
     * Adds the listener to the collection of listeners who will be notified when a {@link com.android.ddmlib.Client}
     * property changed, by sending it one of the messages defined in the
     * {@link com.android.ddmlib.AndroidDebugBridge.IClientChangeListener} interface.
     *
     * @param listener The listener which should be notified.
     */
    ...
    /**
     * Removes the listener from the collection of listeners who will be notified when a
     * {@link com.android.ddmlib.Client} property changed.
     *
     * @param listener The listener which should no longer be notified.
     */
     ...
     * mechanism with <code>adb</code> that does not guarantee that the {@link com.android.ddmlib.IDevice} list has been
     * built before the call to {@link #getDevices()}.
     * <p/>The recommended way to get the list of {@link com.android.ddmlib.IDevice} objects is to create a
     * {@link com.android.ddmlib.AndroidDebugBridge.IDeviceChangeListener} object.
     */
    ...
    /**
     * Returns whether the {@link com.android.ddmlib.AndroidDebugBridge} object is still connected to the adb daemon.
     */
    ...
    /**
     * Returns the number of times the {@link com.android.ddmlib.AndroidDebugBridge} object attempted to connect
     * to the adb daemon.
     */
    ...
    /**
     * Returns the number of times the {@link com.android.ddmlib.AndroidDebugBridge} object attempted to restart
     * the adb daemon.
     */
    ...
    /**
     * Notify the listener of a new {@link com.android.ddmlib.IDevice}.
     * <p/>
     * The notification of the listeners is done in a synchronized block. It is important to
     * expect the listeners to potentially access various methods of {@link com.android.ddmlib.IDevice} as well as
     * {@link #getDevices()} which use internal locks.
     * <p/>
     * For this reason, any call to this method from a method of {@link com.android.ddmlib.DeviceMonitor},
     * {@link com.android.ddmlib.IDevice} which is also inside a synchronized block, should first synchronize on
     * the {@link com.android.ddmlib.AndroidDebugBridge} lock. Access to this lock is done through {@link #getLock()}.
     *
    ...
    /**
     * Notify the listener of a disconnected {@link com.android.ddmlib.IDevice}.
     * <p/>
     * The notification of the listeners is done in a synchronized block. It is important to
     * expect the listeners to potentially access various methods of {@link com.android.ddmlib.IDevice} as well as
     * {@link #getDevices()} which use internal locks.
    ...
    /**
     * Notify the listener of a modified {@link com.android.ddmlib.IDevice}.
     * <p/>
     * The notification of the listeners is done in a synchronized block. It is important to
     * expect the listeners to potentially access various methods of {@link com.android.ddmlib.IDevice} as well as
     * {@link #getDevices()} which use internal locks.
    ...
    /**
     * Notify the listener of a modified {@link com.android.ddmlib.Client}.
     * <p/>
     * The notification of the listeners is done in a synchronized block. It is important to
     * expect the listeners to potentially access various methods of {@link com.android.ddmlib.IDevice} as well as
     * {@link #getDevices()} which use internal locks.
    ...
    /**
     * Returns the {@link com.android.ddmlib.DeviceMonitor} object.
     */
