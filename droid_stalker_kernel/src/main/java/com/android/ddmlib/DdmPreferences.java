...
public final class DdmPreferences {
    ...
    /** Default value for the logcat {@link com.android.ddmlib.Log.LogLevel} */
    ...
    /**
     * Returns the initial {@link com.android.ddmlib.Client} flag for thread updates.
    ...
    /**
     * Sets the initial {@link com.android.ddmlib.Client} flag for thread updates.
     * <p/>This change takes effect right away, for newly created {@link com.android.ddmlib.Client} objects.
     */
    ...
    /**
     * Returns the initial {@link com.android.ddmlib.Client} flag for heap updates.
    ...
    /**
     * Sets the initial {@link com.android.ddmlib.Client} flag for heap updates.
     * <p/>If <code>true</code>, the {@link com.android.ddmlib.ClientData} will automatically be updated with
    ...
    /**
     * Returns the debug port used by the selected {@link com.android.ddmlib.Client}.
     */
    ...
    /**
     * Sets the debug port used by the selected {@link com.android.ddmlib.Client}.
    ...
    /**
     * Returns the debug port used by the first {@link com.android.ddmlib.Client}. Following clients, will use the
     * next port.
     */
    ...
    /**
     * Sets the debug port used by the first {@link com.android.ddmlib.Client}.
    ...
    /**
     * Returns the minimum {@link com.android.ddmlib.Log.LogLevel} being displayed.
     */
    ...
    /**
     * Sets the minimum {@link com.android.ddmlib.Log.LogLevel} to display.
     * <p/>This change takes effect right away.
     */
