 ...
 * <p/>
 * The interface also implements {@link com.android.utils.ILogger} since code that needs to ask for
 * a command-line input will most likely also want to use {@link com.android.utils.ILogger#info(String, Object...)}
...
public interface IReaderLogger extends ILogger {
     ...
     * @throws java.io.IOException as returned by {code System.in.read()}.
     */
