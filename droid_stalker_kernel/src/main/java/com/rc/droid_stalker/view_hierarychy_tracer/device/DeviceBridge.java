...
public class DeviceBridge {
    ...
    public static ViewServerInfo loadViewServerInfo(IDevice device) {
        ...
        try {
            ...
            logger.error("Unable to initialize view server version from device " + device, e);
        } finally {
            if (connection != null) {
                connection.close();
            }
        ...
        try {
            ...
            logger.error("Unable to initialize view server protocol version from device " + device, e);
        } finally {
            if (connection != null) {
                connection.close();
            }
    ...
    public static Window[] loadWindows(final IHvDevice hvDevice, final IDevice device) {
        ...
        try {
            ...
            // initialize the focused window, which was done using a special type of
    ...
    public static int getFocusedWindow(IDevice device) {
        ...
        try {
            ...
            logger.error("Unable to initialize the focused window from device " + device, e);
        } finally {
            if (connection != null) {
                connection.close();
            }
