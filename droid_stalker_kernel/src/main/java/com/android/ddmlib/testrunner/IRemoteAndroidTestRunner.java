...
public interface IRemoteAndroidTestRunner {
    ...
    public static enum TestSize {
        ...
        /**
         * Create a {@link com.android.ddmlib.testrunner.IRemoteAndroidTestRunner.TestSize}.
         *
        ...
        /**
         * Return the {@link com.android.ddmlib.testrunner.IRemoteAndroidTestRunner.TestSize} corresponding to the given Android platform defined value.
         *
         * @throws IllegalArgumentException if {@link com.android.ddmlib.testrunner.IRemoteAndroidTestRunner.TestSize} cannot be found.
         */
     ...
     * Must be called before 'run'.
     *
     * @param size the {@link com.android.ddmlib.testrunner.IRemoteAndroidTestRunner.TestSize} to run.
     */
     ...
     * <p/>
     * @see com.android.ddmlib.testrunner.RemoteAndroidTestRunner#addInstrumentationArg
     *
     * @param name the name of the instrumentation bundle argument
     * @param value the value of the argument
     */
    ...
    /**
     * Set a custom run name to be reported to the {@link com.android.ddmlib.testrunner.ITestRunListener} on {@link #run}
     * <p/>
     ...
     * <p/>
     * Convenience method for {@link #run(java.util.Collection)}.
     *
     ...
     * @throws java.io.IOException if connection to device was lost.
     *
