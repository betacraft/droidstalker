...
public class DroidStalkerKernelService {
  ...
  public interface Iface {
     ...
     * @param lastPacketId
     */
    public Set<CPUStatsStruct> getCPUStatsFor(String debugSession, int lastPacketId) throws DroidStalkerKernelException, TException;
  ...
  public interface AsyncIface {
    ...
    public void getCPUStatsFor(String debugSession, int lastPacketId, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getCPUStatsFor(String debugSession, int lastPacketId) throws TException
    {
    ...
    public Set<CPUStatsStruct> recv_getCPUStatsFor() throws DroidStalkerKernelException, TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getCPUStatsFor_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public getCPUStatsFor_call(String debugSession, int lastPacketId, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.debugSession = debugSession;
      ...
      public Set<CPUStatsStruct> getResult() throws DroidStalkerKernelException, TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    private static class getCPUStatsFor_resultStandardScheme extends StandardScheme<getCPUStatsFor_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.success = new HashSet<CPUStatsStruct>(2*_set24.size);
                  for (int _i25 = 0; _i25 < _set24.size; ++_i25)
                  {
                    CPUStatsStruct _elem26;
                    _elem26 = new CPUStatsStruct();
                    _elem26.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getCPUStatsFor_result struct) throws TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (CPUStatsStruct _iter27 : struct.success)
            {
              _iter27.write(oprot);
            }
            oprot.writeSetEnd();
    ...
    private static class getCPUStatsFor_resultTupleScheme extends TupleScheme<getCPUStatsFor_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getCPUStatsFor_result struct) throws TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (CPUStatsStruct _iter28 : struct.success)
            {
              _iter28.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new HashSet<CPUStatsStruct>(2*_set29.size);
            for (int _i30 = 0; _i30 < _set29.size; ++_i30)
            {
              CPUStatsStruct _elem31;
              _elem31 = new CPUStatsStruct();
              _elem31.read(iprot);
