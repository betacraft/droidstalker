...
/**
 * Centralized point to provide a {@link com.android.ddmlib.DebugPortManager.IDebugPortProvider} to ddmlib.
 *
 * <p/>When {@link com.android.ddmlib.Client} objects are created, they start listening for debuggers on a specific
 * port. The default behavior is to start with {@link com.android.ddmlib.DdmPreferences#getDebugPortBase()} and
 * increment this value for each new <code>Client</code>.
 *
 * <p/>This {@link com.android.ddmlib.DebugPortManager} allows applications using ddmlib to provide a custom
...
public class DebugPortManager {
     ...
     * debugger port for a newly created {@link com.android.ddmlib.Client}.
     */
    public interface IDebugPortProvider {
         ...
         * specified {@link com.android.ddmlib.Device}.
         ...
         * @return The non-random debugger port or {@link #NO_STATIC_PORT} if the {@link com.android.ddmlib.Client}
    ...
    /**
     * Sets the {@link com.android.ddmlib.DebugPortManager.IDebugPortProvider} that will be used when a new {@link com.android.ddmlib.Client} requests
     * a debugger port.
