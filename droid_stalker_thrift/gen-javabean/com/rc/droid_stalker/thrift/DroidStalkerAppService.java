...
public class DroidStalkerAppService {
  ...
  public interface Iface {
     ...
     * @param lastPacketId
     */
    public Set<com.rc.droid_stalker.thrift.CPUStatsStruct> getCPUStatsFor(int pid, int lastPacketId) throws DroidStalkerAppException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getCPUStatsFor(int pid, int lastPacketId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getCPUStatsFor(int pid, int lastPacketId) throws org.apache.thrift.TException
    {
    ...
    public Set<com.rc.droid_stalker.thrift.CPUStatsStruct> recv_getCPUStatsFor() throws DroidStalkerAppException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getCPUStatsFor_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public getCPUStatsFor_call(int pid, int lastPacketId, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.pid = pid;
      ...
      public Set<com.rc.droid_stalker.thrift.CPUStatsStruct> getResult() throws DroidStalkerAppException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    private static class getCPUStatsFor_resultStandardScheme extends StandardScheme<getCPUStatsFor_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.success = new HashSet<com.rc.droid_stalker.thrift.CPUStatsStruct>(2*_set8.size);
                  for (int _i9 = 0; _i9 < _set8.size; ++_i9)
                  {
                    com.rc.droid_stalker.thrift.CPUStatsStruct _elem10;
                    _elem10 = new com.rc.droid_stalker.thrift.CPUStatsStruct();
                    _elem10.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getCPUStatsFor_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (com.rc.droid_stalker.thrift.CPUStatsStruct _iter11 : struct.success)
            {
              _iter11.write(oprot);
            }
            oprot.writeSetEnd();
    ...
    private static class getCPUStatsFor_resultTupleScheme extends TupleScheme<getCPUStatsFor_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getCPUStatsFor_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (com.rc.droid_stalker.thrift.CPUStatsStruct _iter12 : struct.success)
            {
              _iter12.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new HashSet<com.rc.droid_stalker.thrift.CPUStatsStruct>(2*_set13.size);
            for (int _i14 = 0; _i14 < _set13.size; ++_i14)
            {
              com.rc.droid_stalker.thrift.CPUStatsStruct _elem15;
              _elem15 = new com.rc.droid_stalker.thrift.CPUStatsStruct();
              _elem15.read(iprot);
