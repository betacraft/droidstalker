...
public final class AndroidManifest {
    ...
    /**
     * Returns an {@link com.android.io.IAbstractFile} object representing the manifest for the given project.
     *
     ...
     * @throws com.android.io.StreamException If any error happens when reading the manifest.
     */
